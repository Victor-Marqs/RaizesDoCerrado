...
export function ArchiveMotionSection() {
  return (
    <section className="bg-[#060807] px-6 py-28 text-botanical-text md:px-10 md:py-40">
      <div className="mx-auto max-w-6xl">
        <motion.div initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }} className="mb-12 flex flex-col justify-between gap-7 md:flex-row md:items-end">
