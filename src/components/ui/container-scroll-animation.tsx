...
export function ContainerScroll({ titleComponent, children }: ContainerScrollProps) {
  ...
  return (
    <section ref={containerRef} className="relative flex min-h-[58rem] items-start justify-center overflow-hidden px-4 pb-24 pt-20 md:min-h-[76rem] md:px-10 md:pt-28">
      <div className="sticky top-5 flex w-full max-w-6xl flex-col items-center md:top-8" style={{ perspective: '1000px' }}>
        ...
        <motion.div
          ...
          className="mt-8 h-[27rem] w-full overflow-hidden rounded-[28px] border border-botanical-accent/50 bg-[#101310] p-2 shadow-[0_24px_75px_rgba(0,0,0,.56)] md:mt-10 md:h-[39rem] md:rounded-[34px] md:p-3"
        >
