  ...
  return (
    <section className="relative min-h-svh overflow-hidden bg-[#030504]/95 text-botanical-text">
      ...
      <div className="relative flex min-h-svh items-center justify-center px-4 py-24">
        ...
        {expandedContent && <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: expanded ? 1 : 0, y: expanded ? 0 : 18 }} transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }} className="pointer-events-none absolute inset-0 z-20 grid place-items-center p-6 text-center"><div className="w-[min(88vw,42rem)]">{expandedContent}</div></motion.div>}
